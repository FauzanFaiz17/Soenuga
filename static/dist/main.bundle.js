...
var sidebar = __webpack_require__(832);
...
if (document.getElementById('finance-chart')) {
    const chart = new (apexcharts_common_default())(document.getElementById('finance-chart'), getMainChartOptions());
    chart.render();
...
if (financeElement) {
    ...
    const chart = new (apexcharts_common_default())(financeElement, options);
...
var dark_mode = __webpack_require__(924);
